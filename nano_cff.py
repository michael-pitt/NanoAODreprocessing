...
from PhysicsTools.NanoAOD.losttracks_cff import *
from PhysicsTools.NanoAOD.chargedPF_cff import *
from PhysicsTools.NanoAOD.beamspot_cff import *
...
nanoSequenceCommon = cms.Sequence(
        nanoMetadata + jetSequence + muonSequence 
	+ tauSequence + boostedTauSequence + electronSequence + lowPtElectronSequence + photonSequence+vertexSequence+
        isoTrackSequence + jetLepSequence + # must be after all the leptons
        linkedObjects  +
        jetTables + muonTables + tauTables 
	#+ boostedTauTables 
	+ electronTables 
	#+ lowPtElectronTables 
	+ photonTables   
...
nanoSequenceFS = cms.Sequence(genParticleSequence + genVertexTables + particleLevelSequence + nanoSequenceCommon + jetMC + muonMC + electronMC + photonMC + tauMC + metMC +  globalTablesMC + genWeightsTable + genVertexTable + genParticleTables + particleLevelTables + lheInfoTable )
