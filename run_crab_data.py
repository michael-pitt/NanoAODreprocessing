...
# with command line options: step1 --no_exec --data --python_filename run_crab_data.py --fileout NanoAODv9.root --eventcontent NANOAOD --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --step NANO -n 6284 --conditions 106X_dataRun2_v35 --era Run2_2018,run2_nanoAOD_106Xv2
...
process.nanoAOD_step = cms.Path(process.nanoAOD_selection * process.nanoSequence)
