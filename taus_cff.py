...
_tauVarsBase = cms.PSet(P4Vars,
       ...
       dz2 = Var("?signalChargedHadrCands().size()>1?signalChargedHadrCands()[1].dz():-99",float, doc="d_{z} of second track with respect to PV, in cm (with sign)",precision=14),
       dz3 = Var("?signalChargedHadrCands().size()>2?signalChargedHadrCands()[2].dz():-99",float, doc="d_{z} of third track with respect to PV, in cm (with sign)",precision=14),

       tk1Pt = Var("?signalChargedHadrCands().size()>0?signalChargedHadrCands()[0].pt():-99",float, doc="pt of the leading track",precision=10),
       tk1Eta = Var("?signalChargedHadrCands().size()>0?signalChargedHadrCands()[0].eta():-99",float, doc="eta of the leading track",precision=10),
       tk1Phi = Var("?signalChargedHadrCands().size()>0?signalChargedHadrCands()[0].phi():-99",float, doc="phi of the leading track",precision=10),
       tk2Pt = Var("?signalChargedHadrCands().size()>1?signalChargedHadrCands()[1].pt():-99",float, doc="pt of the second track",precision=10),
       tk2Eta = Var("?signalChargedHadrCands().size()>1?signalChargedHadrCands()[1].eta():-99",float, doc="eta of the second track",precision=10),
       tk2Phi = Var("?signalChargedHadrCands().size()>1?signalChargedHadrCands()[1].phi():-99",float, doc="phi of the second track",precision=10),
       tk3Pt = Var("?signalChargedHadrCands().size()>2?signalChargedHadrCands()[2].pt():-99",float, doc="pt of the third track",precision=10),
       tk3Eta = Var("?signalChargedHadrCands().size()>2?signalChargedHadrCands()[2].eta():-99",float, doc="eta of the third track",precision=10),
       tk3Phi = Var("?signalChargedHadrCands().size()>2?signalChargedHadrCands()[2].phi():-99",float, doc="phi of the third track",precision=10),
